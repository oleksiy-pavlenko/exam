...
- Persisted tutor-made interactive visuals live under `processed-docs/04-coach/visualizations/<chapter-id-or-general>/<YYYYMMDD>-<topic-slug>/`.
- Keep source-derived page assets under `processed-docs/assets/pages/`. Do not store tutor-made interactive visuals there.
